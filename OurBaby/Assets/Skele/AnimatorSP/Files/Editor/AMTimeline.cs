...
public class AMTimeline : EditorWindow {
    ...
    private Texture texIconAnimator = (Texture)Resources.Load("am_icon_animator");
    ...
    private Texture texIconScale = (Texture)Resources.Load("am_icon_scale");
	private Texture texIconCameraSwitcher = (Texture)Resources.Load("am_icon_cameraswitcher");

    private Texture texTakeIcon = (Texture)AssetDatabase.LoadAssetAtPath(AnimatorData.BASEDIR+"/Files/Editor/Res/am_timelineTitleIcon.psd", typeof(Texture));
            ...
            if (ator != null)
            {
                ...
                for (int kIdx = 0; kIdx < infos.Count; ++kIdx)
                {
                    ...
                    {// transit
                        ...
                        var aparam = EUtil.AnimatorGetParameter(ator, oneInfo.paramName);
